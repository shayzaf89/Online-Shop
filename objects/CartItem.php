...
class CartItem{
    ...
    return false;
       ...
       /*   count records by userId and if purchased=0   */ 
    public function countRecord(){

    $query="select count(*) as cnt from ".$this->table_name." where userId=? and purchased=0";
...
public function getItemsInCart(){
  ...
  public function updateCartPurchased(){
    ...
    return false;
        ...
        // update purchased items in cart after place order
  public function updatePurchasedAfterCheckOut(){
